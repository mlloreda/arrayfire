...
#pragma once
#include <kernel_headers/confidence_connected.hpp>   // This is the header that gets auto-generated
...
template<typename T>
void confidence_connected(Param out, const Param in, const af_cc_type p)
{
    std::string refName =
        std::string("confidence_connected_") + //<kernel_function_name>_
